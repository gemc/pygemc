...
- Affected repository, version, commit, package, or installation method.
- Operating system, Python version, dependency versions, and relevant options.
...
- Geometry database generation, file parsing, and analyzer behavior.
- Official packaging, build, and test configuration.
...
- Local misconfiguration unrelated to `pygemc`.
